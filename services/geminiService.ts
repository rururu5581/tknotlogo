...
const responseSchema = {
  ...
  properties: {
    ...
    personalizedReason: {
      type: Type.STRING,
      description: `以下の要点をすべて満たす、パーソナライズされた心に響く理由説明を生成します。
- **人間味のある自然な日本語:** AIらしさを感じさせない、柔らかく温かい言葉を選んでください。
- **語りかけるような口調:** 丁寧でありながらも、堅苦しくなりすぎず、読み手に親しみやすく語りかけるスタイルで記述してください。
- **具体的で感情的な表現:** ユーザーの家族構成や夢を具体的に引用し、安心感や希望を感じさせるような感情に訴える言葉を使ってください。
- **定型文の回避:** 「～と考えられます」「～することが推奨されます」といった客観的すぎる表現は使わないでください。`,
    },
    suggestedCoverage: {
      type: Type.ARRAY,
